Public Class Step7
    Private Sub Step7_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
    ...
    Private Sub Step7_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub Step7_Paint(sender As Object, e As PaintEventArgs) Handles MyBase.Paint
        'assign the createGraphics function to the graphics variable
        Dim myGrahics = Me.CreateGraphics
