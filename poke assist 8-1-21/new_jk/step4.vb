Public Class step4
    ...
    Private Sub step4_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        myGrahics.DrawRectangle(ourPen2, New Rectangle(New Point(385, 290), New Size(80, 5)))
    ...
    Private Sub step4_Paint(sender As Object, e As PaintEventArgs) Handles MyBase.Paint
        'assign the createGraphics function to the graphics variable
        Dim myGrahics = Me.CreateGraphics
